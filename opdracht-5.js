/* Verwerkingsopdracht 5 – Bibliotheek (EINDOPDRACHT)
   ...
   SCENARIO
   --------
   De gemeente wil haar bibliotheeksysteem moderniseren. In plaats van met papieren kaartjes moet voortaan alles digitaal worden beheerd. 
   ...
   Op elk moment moeten ook de producten en leden van een specifieke bibliotheek kunnen worden geprint.
    ...
    * Alle klassen die nodig zijn om dit project te maken:
      ...
      * Per klasse alle methoden die de klasse heeft
        * Noteer de naam, en als ze  aanwezig zijn het parameter type en/of return type
    * Teken alle overervingsrelaties met juiste pijl(en) (met lege driehoek als punt)
    * Noteer naast de klasse naam  "abstract" voor alle abstracte klassen
    * Teken voor alle associaties de pijlen met de relaties (1-1, 1-5, 1-*, *-*, ...)

   DEEL 2 – Implementatie
   -----------------------------------
   Neem het UML-diagram uit de vorige stap en zet deze om naar code. Gebruik de vorige opdrachten als je ergens mee vastloopt. 
   ...
   Werk per klasse met het opschrijven van de klasse en de mogelijke superklasse, dan de atributen, de constructor, en daarna andere methoden.
